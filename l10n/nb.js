OC.L10N.register(
    ...
    "Token:" : "Token:",
    "Set the required token. To get a token, visit:" : "Angi ønsket token. For å få et token, besøk:",
    "Unsplash: Developer Account Instructions" : "Unsplash: Instruksjoner for utviklerkonto",
    "On the linked instruction page, register an application. You should not need to apply for production. Use their token here." : "På den koblede instruksjonssiden registrerer du en applikasjon. Du skal ikke behøve å søke om produksjon. Bruk deres token her.",
    "Preview:" : "Forhåndsvisning:",
    "Refresh Cached Image" : "Oppfrisk bufret bilde",
