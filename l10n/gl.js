OC.L10N.register(
    ...
    "These images are provided %1%s by %2%s." : "Estas imaxes son fornecidas %1%s por %2%s.",
    ...
    "Set random image as dashboard background" : "Definir unha imaxe ao chou como fondo do taboleiro",
    "Set the image provider:" : "Definir o provedor de imaxes:",
    ...
    "On the linked instruction page, register an application. You should not need to apply for production. Use their token here." : "Na páxina de instrucións ligada, rexistre unha aplicación. Non debería ter necesidade de solicitar a produción. Use aquí o seu testemuño.",
    "Preview:" : "Vista previa:",
    "Refresh Cached Image" : "Actualizar a imaxe na memoria tobo",
    ...
    "Enable Tint" : "Activar o tintado",
    "Set the vibrancy of the color" : "Definir a intensidade da cor",
    "Set the blur of the image" : "Definir o esvaemento da imaxe",
    ...
    "Random Background Images" : "Imaxes de fondo ao chou",
    "%s is customized with random background images." : "%s está personalizado con imaxes de fondo ao chou.",
